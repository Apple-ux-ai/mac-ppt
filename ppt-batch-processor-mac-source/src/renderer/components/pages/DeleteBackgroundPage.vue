  ...
  >
    <template #config>
      <div class="config-section">
        <div class="info-box">
          <strong>{{ t('删除背景') }}</strong>
          <p>{{ t('移除幻灯片的背景图片或背景色') }}</p>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="checkbox-grid">
            <label class="checkbox-item">
              <input type="checkbox" v-model="options.removeImages" />
              <span>{{ t('删除背景图片') }}</span>
            </label>
            <label class="checkbox-item">
              <input type="checkbox" v-model="options.removeColors" />
              <span>{{ t('删除背景色') }}</span>
            </label>
            <label class="checkbox-item">
              <input type="checkbox" v-model="options.applyToMaster" />
              <span>{{ t('应用到母版') }}</span>
            </label>
          </div>
        </div>

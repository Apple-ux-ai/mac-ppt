export enum ErrorCode {
  ...
  FILE_TOO_LARGE = 1004,
  FILE_CORRUPTED = 1005,
  FILE_INVALID_FORMAT = 1006,
  FILE_ALREADY_EXISTS = 1007,
  FILE_ENCRYPTED = 1008,
  DIRECTORY_NOT_FOUND = 1009,
  DIRECTORY_ACCESS_DENIED = 1010,
  INVALID_PPTX_STRUCTURE = 2001,
  INVALID_SLIDE_INDEX = 2002,
  INVALID_PAGE_RANGE = 2003,
  INVALID_METADATA = 2004,
  IMAGE_NOT_FOUND = 2005,
  IMAGE_FORMAT_UNSUPPORTED = 2006,
  TEXT_NOT_FOUND = 2007,
  TEMPLATE_PARSE_ERROR = 2008,
  EXCEL_PARSE_ERROR = 2009,
  WATERMARK_FAILED = 2010,
  PASSWORD_INCORRECT = 2011,
  PASSWORD_REQUIRED = 2012,
  LIBREOFFICE_NOT_FOUND = 3001,
  LIBREOFFICE_TIMEOUT = 3002,
  LIBREOFFICE_CRASH = 3003,
  CONVERSION_FAILED = 3004,
  IMAGEMAGICK_NOT_FOUND = 3005,
  GHOSTSCRIPT_NOT_FOUND = 3006,
  TASK_CANCELLED = 4001,
  TASK_TIMEOUT = 4002,
  TASK_ALREADY_RUNNING = 4003,
  TASK_NOT_FOUND = 4004,
  TASK_QUEUE_FULL = 4005,
  INSUFFICIENT_MEMORY = 5001,
  INSUFFICIENT_DISK_SPACE = 5002,
  TEMP_DIR_CREATION_FAILED = 5003,
  BACKUP_FAILED = 5004,
  NETWORK_ERROR = 6001,
  API_ERROR = 6002,
...
export const ERROR_DETAILS: Record<ErrorCode, Omit<ErrorDetail, 'context'>> = {
  [ErrorCode.SUCCESS]: {
...
export class AppError extends Error {
  ...
  constructor(code: ErrorCode, context?: Record<string, any>, originalError?: Error) {
  ...
  static fromError(error: unknown, defaultCode: ErrorCode = ErrorCode.UNKNOWN_ERROR): AppError {

...
class FileValidator {
    ...
    async extractBasicInfo(filePath, stats) {
        return {
            path: filePath,
        ...
        try {
            ...
            if (ext === '.pptx' || ext === '.pptm') {
                ...
                if (corePropsFile) {
                    ...
                    const modifiedByMatch = xmlContent.match(/<cp:lastModifiedBy>([^<]*)<\/cp:lastModifiedBy>/);
                    return {

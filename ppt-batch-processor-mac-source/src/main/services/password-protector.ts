...
export class PasswordProtector {
   ...
   * @param password 密码
   */
  async addPassword(inputPath: string, outputPath: string, password: string): Promise<void> {
    try {
   ...
   */
  async removePassword(inputPath: string, outputPath: string, currentPassword: string): Promise<void> {
    try {

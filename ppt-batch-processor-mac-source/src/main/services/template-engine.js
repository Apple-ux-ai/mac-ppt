...
export class TemplateEngine {
     ...
     */
    async parseDataSource(dataSourcePath) {
        try {
            // 检查文件是否存在
     ...
     * @throws Error 如果生成失败
     */
    async generate(template, data, outputPath) {
        try {
            // 创建模板文档的深拷贝
     ...
     */
    async batchGenerate(template, dataList, outputDir, outputPattern) {
        try {
            // 验证输出目录
     ...
     */
    async mergeGenerate(template, dataList, outputPath) {
        try {
